...
import com.example.restaurant.filter.JwtAuthenticationTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http//关闭csrf
                ...
                .authorizeRequests()
                // 对于登录接口 允许匿名访问
                .antMatchers("/deleteRestaurant").anonymous()
                ...
                .antMatchers("/addTables").anonymous()
                .antMatchers("/getTables").anonymous()
                .antMatchers("/deleteTables").anonymous()
                // 除上面外的所有请求全部需要鉴权认证
